...
from .views import available_product_list, out_of_stock_product_list, update_product_status, create_product, process_order
...
urlpatterns = [
    ...
    path('order/', process_order, name='process-order'),
]
